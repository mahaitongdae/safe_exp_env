...
def test_end2end():
    env = CrossroadEnd2end(training_task='right', num_future_data=5)
    obs = env.reset()
    i = 0
    done = 0
    while i < 100000:
